// They finish in the same amount of time.
// Gallant directly stopped swimming after entering the lake at the temperature of 78F, but Goofus stops after a minute at the temperature of 77.5F.
// No, he just dive in.
// No, he just dive in, too.
// The while loop tests the condition before executing any of the statements within the while loop whereas the do-while loop tests the condition after the statements have been executed within the loop.
// Pre-test loop = Do-while loop / Post-test loop = While loop
